...
class NearPolice : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nearps)
        ...
        when {
            PermissionUtils.isAccessFineLocationGranted(this) -> {
                ...
                PermissionUtils.requestAccessFineLocationPermission(
                    this,
                    NearPolice.LOCATION_PERMISSION_REQUEST_CODE
                )
            }
        }
    }
    ...
    private fun findNearbyHospitals(location: LatLng) {
        ...
        val url =
            "https://maps.googleapis.com/maps/api/place/nearbysearch/json?" +
                    ...
                    "&radius=1500&type=police&key=AIzaSyCWeQENE3deFewK51yClc6xgtb2RYPVPhI"
